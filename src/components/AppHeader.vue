<template>
  <header class="header">
    <nav class="header-navbar" v-if="mobileView">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="6">
          <g fill-rule="evenodd"><path d="M0 0h20v1H0zM0 5h20v1H0z" /></g>
        </svg>
      </div>
      <div
        class="header-navbar-iconClose"
        :class="{ active: isActive }"
        @click.prevent="toggleMenu"
      >
    ...
    <nav class="header-navbar" v-else>
      <div class="header-navbar-logo">
        <svg xmlns="http://www.w3.org/2000/svg" width="170" height="16">
          <defs>
            <linearGradient id="a" x1="0%" x2="50%" y1="85.457%" y2="14.543%">
...
export default {
  data() {
    return {
      isActive: false,
      mobileView: window.innerWidth < 470 ? true : false,
    };
  },
  methods: {
    toggleMenu() {
