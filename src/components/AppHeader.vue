<template>
  <header class="header">
    <nav class="header-navbar">
      ...
      <div class="header-navbar-icon" :class="{ 'active' : isActive }" @click.prevent="toggleMenu">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="6"><g fill-rule="evenodd"><path d="M0 0h20v1H0zM0 5h20v1H0z"/></g></svg>
      </div>
      <div class="header-navbar-iconClose" :class="{ 'active' : isActive }" @click.prevent="toggleMenu">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15"><path fill-rule="evenodd" d="M14.718.075l.707.707L8.707 7.5l6.718 6.718-.707.707L8 8.207l-6.718 6.718-.707-.707L7.293 7.5.575.782l.707-.707L8 6.793 14.718.075z"/></svg>
      </div>
      <ul class="header-navbar-list" v-if="isActive">
        <li class="header-navbar-list-item"><a>Stories</a></li>
        <li class="header-navbar-list-item"><a href="">Features</a></li>
        <li class="header-navbar-list-item"><a href="">Pricing</a></li>
        <hr>
        <li class="header-navbar-list-item"><button class="btn">Get an invite</button></li>
      </ul>
    </nav>
  </header>
</template>
